...
// Dashboard
    return (
                ...
                <nav className="h-14 -mt-3 pb-4 bg-gray-50 fixed w-full z-50 border-b border-t border-gray-400 transition-all duration-300 flex items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <h2 className=" mt-3 text-lg font-semibold flex items-center">
                    ...
                    <Link to={'/home'} className="text-md font-bold text-gray-600 mt-3 -mr-4">Hi, {user.name}! 👋</Link>
