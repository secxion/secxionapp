            ...
            <button
                ...
                <div className="relative items-center text-sm text-gray-700 dark:text-gray-200">
                    <div className="items-center space-x-2 cursor-pointer" onClick={toggleTimezones}>
                        ...
                        {showTimezones && (
                            <div className="absolute bottom-full left-0 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-md z-10 overflow-y-auto max-h-40">
                                {timezones.map((tz) => (
                                    <div
                                        key={tz.value}
