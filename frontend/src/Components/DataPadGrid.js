...
const GridCard = ({ dataPad, onEdit, onDelete, onView }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-200 cursor-pointer group h-full flex flex-col"
