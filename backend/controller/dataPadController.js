const DataPad = require("../models/dataPad");
...
const getAllDataPads = async (req, res) => {
    try {
...
const createDataPad = async (req, res) => {
    try {
...
const updateDataPad = async (req, res) => {
    try {
        const { id } = req.params;
        const { title, content, media } = req.body;
        const userId = req.userId;
...
const deleteDataPad = async (req, res) => {
    try {
        const { id } = req.params;
        const userId = req.userId;
